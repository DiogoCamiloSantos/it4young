...
const TabItemDescriptionStyle = styled(Label)`
    font-size: 8px;
    line-height: 12px;
`
...
const SvgImage = styled(SvgCssUri)` 
    ...
    return (
        <TabItemStyle onTouchEnd={() => props.onSelectedTab()}>
            <WrapperStyle activated={props.activated}>
                <SvgImage fill={theme.color.font} width={20} uri={resolveSvg(props.icon)} />
            </WrapperStyle>
            <View>
                <TabItemDescriptionStyle>{props.description}</TabItemDescriptionStyle>
